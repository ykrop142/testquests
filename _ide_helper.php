 ...
 * Generated for Laravel 7.20.0 on 2020-09-22 09:38:34.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Redirect {
        ...
        /**
         * Create a new redirect response to the "main" route.
         *
         * @param int $status
         * @return \Illuminate\Http\RedirectResponse
         * @static
         */
        public static function main($status = 302)
        {
                        /** @var \Illuminate\Routing\Redirector $instance */
                        return $instance->main($status);
        }
